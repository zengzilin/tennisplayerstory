...
const MyArticlesPageClient = ({ lang }: { lang: LangCode }) => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-card rounded-xl border border-border shadow-sm">
              ...
              <Button variant="outline" onClick={() => router.push(`/${lang}/${localizedRouteNames['write-article'][lang]}`)}>
                {t('articles.startWriting')}
              </Button>
            </div>
          ) : (
            <motion.div
...
export default MyArticlesPageClient;
